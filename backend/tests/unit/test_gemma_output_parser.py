...
def test_parse_investigation_output_validates_scenarios():
    parsed = parse_investigation_output('{"case_summary":"Review required","scenarios":[{"scenario_id":"SCN-1","category":"SUSPICIOUS","name":"Transaction Layering","description":"Rapid movement","expected_signals":[{"signal":"large_incoming_transaction","weight":0.5},{"signal":"new_beneficiaries","weight":0.5}]}],"recommended_actions":["Verify suppliers"]}')
