...
def test_build_financial_twin_merges_behavior_and_business_profile():
    ...
    customer = CustomerProfile(customer_id="C1", customer_type="BUSINESS", declared_business="Textile Retail", declared_monthly_turnover=700000, country="India", account_age_months=36, kyc_status="VERIFIED")
