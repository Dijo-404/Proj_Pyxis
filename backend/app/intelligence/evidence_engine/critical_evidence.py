...
def find_decision_critical_evidence(comparisons: list[EvidenceComparison]) -> DecisionCriticalEvidence:
    ...
    if not unknown_signals:
        return DecisionCriticalEvidence(
            ...
            why_it_matters="The current evidence does not expose a single unresolved high-impact signal.",
    ...
    return DecisionCriticalEvidence(
        ...
        why_it_matters=f"The unresolved signal '{readable}' has the highest scenario weight among unknown evidence.",
