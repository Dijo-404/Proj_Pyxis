...
class LocalFallbackGemmaProvider:
    def investigate(self, evidence_package: dict) -> str:
        return json.dumps(
            {
                "case_summary": "Local Gemma investigation indicates the transaction requires review against competing legitimate and suspicious scenarios.",
                "recommended_actions": ["Verify beneficiary supplier relationships", "Request source-of-funds evidence"],
                "scenarios": [
                    {
                        "scenario_id": "SCN-LEGIT-001",
                        "category": "LEGITIMATE",
                        "name": "Legitimate Business Payment",
                        "description": "The transaction may represent a valid business settlement or expansion payment.",
                        "expected_signals": [
                    ...
                    },
                    {
                        ...
                        "description": "Large unusual funds may be moving through the account toward weakly known beneficiaries.",
                        "expected_signals": [
                    ...
                    },
                    {
                        ...
                        "description": "The case cannot be resolved without stronger beneficiary and document evidence.",
                        "expected_signals": [
