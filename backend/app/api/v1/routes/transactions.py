...
def evaluate_transaction(
    request: TransactionEvaluateRequest, session: SessionDependency
    ...
    history = risk_case_service.transactions.list_for_customer(
        request.customer_profile.customer_id
    )
