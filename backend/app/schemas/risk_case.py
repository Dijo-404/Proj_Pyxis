...
class RiskCaseResponse(BaseModel):
    ...
    def demo_case(cls) -> "RiskCaseResponse":
        ...
        anomaly = AnomalyAssessment(
            ...
            triggered_rules=[
                TriggeredRule(
                    rule_id="amount_above_customer_p95",
                    severity="HIGH",
        ...
        scenario = Scenario(
            ...
            description="Rapid redistribution of unusual funds.",
            expected_signals=[{"signal": "large_incoming_transaction", "weight": 1}],
        )
        ...
        critical = DecisionCriticalEvidence(
            question="Are the beneficiaries verified supplier relationships?",
            why_it_matters="This separates legitimate supplier settlement from layering.",
            recommended_action="Request supplier records.",
        )
        return cls(
            case_id="CASE-DEMO",
            customer_id="CUST-001",
            trigger_transaction_id="TXN-DEMO",
            initial_anomaly_score=89,
